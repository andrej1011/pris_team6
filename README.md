...
Developed for the **Information Systems Development (PRIS)** university course, this project provides critical insights into chip architecture, signal congestion, and routing conflicts for advanced Electronic Design Automation (EDA) research.
